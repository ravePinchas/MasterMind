...
public class CheosPlate : MonoBehaviour
{
    ...
    public void OnMouseUp()
    {
        ...
        objreplaceX = reference.GetComponent<Chessman>().GetXBoard();
        objreplaceY = reference.GetComponent<Chessman>().GetYBoard();

        //enemy object
        GameObject objReplace = controller.GetComponent<Game>().GetPosition(matrixX, matrixY);

        controller.GetComponent<Game>().ChangeReplacerPosition(reference, objReplace);

        //reference is now in the place of the obj
        ...
        reference.GetComponent<Chessman>().DestroyCheosPlates();
